    ...
    public class BuildCommand : ICommand
    {
        ...
        public Task<bool> ExecuteAsync()
        {
            return Task.Run(() =>
            {
                ...
                ProcessHelper.CmdExecute($"npx electron-builder . --config=./bin/electron-builder.json --{platformInfo.ElectronPackerPlatform} --{electronArch} -c.electronVersion=8.2.0 {electronParams}", tempPath);
